...
from etl.defs.i_tx_metadata_asset import (
    ...
    ingestion_cleanup_d_tx_metadata_offline_asset,
    ingestion_cleanup_d_tx_metadata_web_search_asset,
...
from etl.defs.k_tax_module_asset import (
    ...
    ingestion_cleanup_d_tax_module_asset,
...
ingestion_cleanup_d = dg.define_asset_job(
    name="ingestion_cleanup_d",
    description="Sections cleanup job; starts from verified XML agreements that need sections.",
    executor_def=SAFE_ETL_EXECUTOR,
    hooks={_managed_logical_run_failure_hook},
    selection=dg.AssetSelection.assets(
        ingestion_cleanup_d_sections_asset,
