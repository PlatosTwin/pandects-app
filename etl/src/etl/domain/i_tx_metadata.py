...
TX_METADATA_OFFLINE_INSTRUCTIONS = (
    ...
    "For SPAC / de-SPAC business combination agreements with multiple parties (a SPAC, a new holding company "
    "often defined as 'Pubco' or 'Holdco', and one or more Merger Subs), the acquirer is the SPAC itself — "
    "the party with the trust account, usually defined as the 'Purchaser' or 'SPAC' and typically named "
    "'... Acquisition Corp.' — NOT the new holding company that survives the combination and NOT a Merger Sub. "
