          ...
          <div className="bg-white rounded-lg border border-material-divider p-6 min-w-0">
            ...
            <div className="bg-gray-50 rounded p-4 text-xs font-mono overflow-x-auto relative group">
              <button
                ...
                className="sticky top-3 right-3 float-right p-1.5 rounded bg-white shadow-sm border border-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-200 hover:bg-gray-50 z-10 ml-2"
