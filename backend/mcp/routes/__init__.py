            ...
            return _json_rpc_result(
                ...
                result={
                    ...
                    "instructions": (
                        ...
                        "Dataset and schema changes are documented in the changelog (see the "
                        "changelog section of get_server_capabilities); check it when results seem "
                        "to have changed across sessions. "
